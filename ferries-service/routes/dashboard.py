...
def trips(
    ...
    return get_trips_dashboard(origin, destination, date, pax, ferry_class)
...
def roundtrip(
    ...
    return get_roundtrip_dashboard(origin, destination, depart_date, return_date, pax, ferry_class)
